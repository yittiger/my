...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      pictorialSymbol(row, index) {
        return {
          symbol: pathSymbols[row[0]]
        }
      },
      mapLoader() {
