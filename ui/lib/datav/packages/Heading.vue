<template>
  <Box class="my-dv-heading" :class="classes" v-bind="$attrs" v-on="$listeners">
    <MyIcon class="my-dv-heading__icon" v-if="iconProps" v-bind="iconProps"></MyIcon>
    <slot></slot>
  </Box>
</template>
