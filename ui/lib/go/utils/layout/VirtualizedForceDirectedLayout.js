...
function getVirtualizedForceDirectedLayout(go) {
  ...
  return VirtualizedForceDirectedLayout
}
export default getVirtualizedForceDirectedLayout
export function handlerVirtualForce(
  go,
  diagram,
  myWholeModel,
  isInit = true,
